...
class Raton extends DipositivosEntrada{
...
let teclado2 = new Teclado('Buetooth', 'MSI');
...
console.log(`${computadora1}`); //Llamado automatico del toString
...
class Orden{
    ...
    mostrarOrden(){
        let computadorasOrden = ''; //Variable vacia
